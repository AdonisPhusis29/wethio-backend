...
func TestDefaultGenesisBlock(t *testing.T) {
	...
	if block.Hash() != params.ZynMainnetGenesisHash {
		t.Errorf("wrong mainnet genesis hash, got %v, want %v", block.Hash().String(), params.ZynMainnetGenesisHash.String())
	}
...
func TestSetupGenesis(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			wantHash:   params.ZynMainnetGenesisHash,
			wantConfig: params.ZynMainnetChainConfig,
		},
		{
