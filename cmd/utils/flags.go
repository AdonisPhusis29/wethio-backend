...
var (
	...
	NetworkIdFlag = cli.Uint64Flag{
		Name:  "networkid",
		Usage: "Network identifier (integer, 89=Zynecoin)",
	...
	ZynTestnetFlag = cli.BoolFlag{
		Name:  "zyn-testnet",
		Usage: "Zyn test network",
	}
	...
	TargetGasLimitFlag = cli.Uint64Flag{
		...
		Value: params.ZynGenesisGasLimit,
	}
...
func setBootstrapNodes(ctx *cli.Context, cfg *p2p.Config) {
	...
	case ctx.GlobalBool(ZynTestnetFlag.Name):
		urls = params.TestnetBootnodes
	}
...
// for zyn and returns half of the allowance to assign to the database.
...
func MakeAddress(ks *keystore.KeyStore, account string) (accounts.Account, error) {
	...
	log.Warn("Please use explicit addresses! (can search via `zyn account list`)")
	log.Warn("-------------------------------------------------------------------")
...
func SetEthConfig(ctx *cli.Context, stack *node.Node, cfg *eth.Config) {
	...
	if ctx.GlobalIsSet(StoreRewardFlag.Name) {
		common.StoreRewardFolder = filepath.Join(stack.DataDir(), "zyn", "rewards")
...
// new format.
//
// e.g. zyn account new --keystore /tmp/mykeystore --lightkdf
//
// is equivalent after calling this method with:
//
// zyn --keystore /tmp/mykeystore --lightkdf account new
//
